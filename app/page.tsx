  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <main className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="bg-blue-50 dark:bg-blue-900/30 border-l-4 border-blue-500 p-4 mb-12 rounded-r-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-md">
            ...
            <ul className="space-y-2 text-gray-600 dark:text-gray-300">
              <li className="flex items-center">
                <span className="mr-2">✓</span> Project setup and configuration
              </li>
              <li className="flex items-center">
                <span className="mr-2">✓</span> Responsive layout design
              </li>
              <li className="flex items-center">
                <span className="mr-2">✓</span> Car listing showcase
              </li>
              <li className="flex items-center">
                <span className="mr-2">✓</span> Image optimization with Next.js
              </li>
            </ul>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-md">
            ...
            <ul className="space-y-2 text-gray-600 dark:text-gray-300">
              <li className="flex items-center">
                <span className="mr-2">→</span> Advanced search and filters
              </li>
              <li className="flex items-center">
                <span className="mr-2">→</span> Vehicle details pages
              </li>
              <li className="flex items-center">
                <span className="mr-2">→</span> Contact forms and inquiries
              </li>
              <li className="flex items-center">
